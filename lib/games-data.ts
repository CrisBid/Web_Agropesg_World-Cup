...
// Terceiro e final não pontuam aqui: acertar quem ganha esses dois jogos já é
// coberto pelos palpites bônus "3º Colocado" (10 pts) e "Campeão" (15 pts).
export const KNOCKOUT_GAME_PTS: Record<Phase, number> = {
  ...
  terceiro: 0,                    // pontua via bônus "3º Colocado" (10 pts)
  final: 0,                       // pontua via bônus "Campeão" (15 pts)
};
